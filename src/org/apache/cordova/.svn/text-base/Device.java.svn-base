...
import com.alipay.android.core.EngineConfig;
import com.alipay.android.core.webapp.Page;

public class Device extends Plugin {
    public static final String TAG = "Device";

    public static String cordovaVersion = EngineConfig.MAJOR + "." + EngineConfig.MINOR + "."
                                          + EngineConfig.REVISION; // Cordova version:1.6.0rc1
    ...
    public void onDestroy() {
        if (this.telephonyReceiver != null) {
            try {
                mPage.getContext().unregisterReceiver(this.telephonyReceiver);
    ...
    private void initTelephonyReceiver() {
        if (telephonyReceiver == null) {
                    ...
                    if ((intent != null)
                        ...
                        if (intent.hasExtra(TelephonyManager.EXTRA_STATE)) {
                            ...
                            if (extraData.equals(TelephonyManager.EXTRA_STATE_RINGING)) {
                                ...
                                mPage.postMessage("telephone", "ringing");
                            } else if (extraData.equals(TelephonyManager.EXTRA_STATE_OFFHOOK)) {
                                LOG.i(TAG, "Telephone OFFHOOK");
                                mPage.postMessage("telephone", "offhook");
                            } else if (extraData.equals(TelephonyManager.EXTRA_STATE_IDLE)) {
                                LOG.i(TAG, "Telephone IDLE");
                                mPage.postMessage("telephone", "idle");
                            }
                        }
                    }
                }
            ...
            mPage.getContext().registerReceiver(this.telephonyReceiver, intentFilter);
        }
    }
    ...
    public String getUuid() {
        String uuid = Settings.Secure.getString(mPage.getContext().getContentResolver(),
