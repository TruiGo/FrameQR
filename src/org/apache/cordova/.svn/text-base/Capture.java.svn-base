...
public class Capture extends Plugin {
    ...
    private void captureAudio() {
        ...
        mPage.getRunTime().startActivityForResult(mPage.getContext(),(Plugin) this, intent, CAPTURE_AUDIO);
    }
    ...
    private void captureImage() {
        ...
        File photo = new File(DirectoryManager.getTempDirectoryPath(mPage.getContext()),
            "Capture.jpg");
        intent.putExtra(android.provider.MediaStore.EXTRA_OUTPUT, Uri.fromFile(photo));
        this.imageUri = Uri.fromFile(photo);

        mPage.getRunTime().startActivityForResult(mPage.getContext(),(Plugin) this, intent, CAPTURE_IMAGE);
    }
    ...
    private void captureVideo(double duration) {
        ...
        mPage.getRunTime().startActivityForResult(mPage.getContext(),(Plugin) this, intent, CAPTURE_VIDEO);
    }
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (requestCode == CAPTURE_AUDIO) {
                ...
                try {
                    ...
                    Bitmap bitmap = android.provider.MediaStore.Images.Media.getBitmap(mPage
                    ...
                    OutputStream os = mPage.getContext().getContentResolver().openOutputStream(uri);
    ...
    private JSONObject createMediaFile(Uri data) {
        File fp = new File(FileUtils.getRealPathFromURI(data, mPage));
        JSONObject obj = new JSONObject();
