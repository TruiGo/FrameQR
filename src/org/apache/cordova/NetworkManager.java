...
public class NetworkManager extends Plugin {
    ...
    public void setContext(Page page) {
        ...
        this.sockMan = (ConnectivityManager) mPage.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);        
        ...
        if (this.receiver == null) {
            ...
            mPage.getContext().registerReceiver(this.receiver, intentFilter);
        }
    ...
    public void onDestroy() {
        if (this.receiver != null) {
            try {
                mPage.getContext().unregisterReceiver(this.receiver);
                this.receiver = null;
            } catch (Exception e) {
    ...
    private void sendUpdate(String type) {
        ...
        // Send to all plugins
        mPage.postMessage("networkconnection", type);
    }
