...
public abstract class Plugin implements IPlugin {
    ...
    public void sendJavascript(String statement) {
        mPage.sendJavascript(statement);
    }
    ...
    public void success(PluginResult pluginResult, String callbackId) {
        mPage.sendJavascript(pluginResult.toSuccessCallbackString(callbackId));
    }
    ...
    public void success(JSONObject message, String callbackId) {
        mPage.sendJavascript(new PluginResult(PluginResult.Status.OK, message).toSuccessCallbackString(callbackId));
    }
    ...
    public void error(PluginResult pluginResult, String callbackId) {
        mPage.sendJavascript(pluginResult.toErrorCallbackString(callbackId));
    }
    ...
    public void error(JSONObject message, String callbackId) {
        mPage.sendJavascript(new PluginResult(PluginResult.Status.ERROR, message).toErrorCallbackString(callbackId));
    }
