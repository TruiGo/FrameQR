...
public final class QRCodeEncoder {
  ...
  private static final int YELLOW = 0xFFFA6A00;
  private static final int RED = 0xFFE26926;
  ...
  public QRCodeEncoder(Context context, Intent intent) {
  ...
  public void requestBarcode(Handler handler, int widthResolution, int hightResolution) {
	    Thread encodeThread = new EncodeThread(contents, handler, widthResolution, hightResolution, format);
	    encodeThread.start();
	  }
...
//    System.out.println("desiredWidth="+desiredWidth +", desiredHeight="+desiredHeight);
    ...
    int color = BLACK;
    if (format.getName().equals("QR_CODE")) {
//    	color = YELLOW;
    }
