...
//        LogUtil.LogOut(2, "Connection", "packageListener in the list is " + recvListeners.size());
     ...
     */
    public abstract void connect(TaskListener taskListener) throws XMPPException;
    ...
    public void addPacketListener(PacketListener packetListener, PacketFilter packetFilter) {
        ...
        ListenerWrapper wrapper = new ListenerWrapper(packetListener, packetFilter);
        recvListeners.put(packetListener, wrapper);
        LogUtil.LogOut(5, "Connection", "packageListener in the list is " + recvListeners.size());
    }
